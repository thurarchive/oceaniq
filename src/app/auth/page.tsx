                ...
                <div className="glass-card-elevated p-8 auth-card-glow border border-primary/10">
                    ...
                    <div className="mb-6">
                        <h1 className="text-xl font-bold text-foreground mb-1">
                            {mode === 'login' ? 'Welcome back' : mode === 'signup' ? 'Join Oceaniq' : 'Reset your password'}
                        </h1>
                        <p className="text-sm text-muted-foreground">
                            {mode === 'login'
                                ? 'Sign in to access your monitoring dashboard'
                                : mode === 'signup'
                                    ? 'Create an account to start monitoring marine waste'
                                ...
                                <div className="flex items-center justify-between mb-1.5">
                                    ...
                                    {mode === 'login' && (
                                        <button
                                            ...
                                            className="text-xs text-primary hover:text-sky-300 transition-colors disabled:opacity-50"
                                        >
                                            Forgot password?
                                        </button>
                                    )}
